                    ...
                    <div class="row">
                        <div class="col-md-5 my-2">
                             <div class="card">
                                ...
                                @inject('delivery_id', 'App\Http\Controllers\Admin\OrderController')
                                 @foreach($deliveryData as $dm)
                                        <!-- wqw -->
                                   <div class="row mt-5">
                                       <div class="col-md-12">
                                          <div class="ml-3">
                                               <h3>{{$dm->f_name.' '.$dm->l_name}} (Today Completed: {{$dm->current_orders}})</h3>
                                            <h6>Assigned   :  {{$dm->current_orders}}</h6>
                                            <h6>On the Way   :  {{ $delivery_id::get_on_the_way($dm->id) }}
                                            </h6>
                                            <h6>Handover   :   {{ $delivery_id::get_handover($dm->id) }}</h6>
                                            <h6>Total   :  {{$dm->assigned_order_count}}</h6>
                                          </div>
                                       </div>
                                   </div>
