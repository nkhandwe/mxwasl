...
Route::post('wallet/razorpay', 'AddFundController@razorpay_payment')->name('wallet.payment-razor');
...
Route::get('wallet/paytm-payment', 'AddFundController@paytm_payment')->name('wallet.paytm-payment');
Route::any('wallet/paytm-response', 'AddFundController@paytm_callback')->name('wallet.paytm-response');
...
Route::get('wallet-add-fund','AddFundController@load_payment');
