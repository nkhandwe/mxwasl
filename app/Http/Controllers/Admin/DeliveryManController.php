...
class DeliveryManController extends Controller
{
    ...
    public function store(Request $request)
    {
        ...
        $dm->commission = $request->commission;
        $dm->commission_type = $request->commission_type;
    ...
    public function update(Request $request, $id)
    {
        ...
        $delivery_man->commission = $request->commission;
        $delivery_man->commission_type = $request->commission_type;
    ...
    public function export(Request $request){
        ...
        if($request->type == 'excel'){
            return (new FastExcel($delivery_men))->download('DeliveryMans.xlsx');
        }elseif($request->type == 'csv'){
            return (new FastExcel($delivery_men))->download('DeliveryMans.csv');
        }
    }
}
