            ...
            <div class="col-lg-3">
                <div class="card h-100">
                    <div class="card-body d-flex flex-column justify-content-center">
                                @if($product->store)
                        <a class="resturant--information-single" href="{{route('admin.store.view', $product->store_id)}}">
                        ...
                        <tr>
                            <td>
                                @if ($review->customer)
                                    ...
                                    <span class="ml-8"><a href="{{route('admin.order.details',['id'=>$review->order_id])}}">{{ translate('messages.order_id') }}: {{$review->order_id}}</a></span>
                                @else
