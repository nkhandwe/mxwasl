                            ...
                            <div class="row g-3">
                                ...
                                <div class="col-sm-6">
                                    <div class="form-group mb-0">
                                        ...
                                        <select name="earning" class="form-control deliverymantype">
                                ...
                                <div class="col-sm-6 commissionData displaynone">
                                    <div  class="row">
                                        <div class="col-md-6">
                                           ...
                                           <input type="text" oninput="this.value = this.value.replace(/[^0-9.]/g, '').replace(/(\..*?)\..*/g, '$1');" name="commission" class="form-control" placeholder="{{translate('messages.Commission')}}" required>
                                            </div>
                                        </div>
                                        <div class="col-md-6 ">
