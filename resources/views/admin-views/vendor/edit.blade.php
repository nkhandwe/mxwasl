                ...
                <div class="card">
                    ...
                    <div class="card-body">
                        <div class="row g-3 mb-0">
                            ...
                            <div class="col-lg-4 col-sm-6">
                                <div class="form-group mb-0">
                                    <label class="input-label" for="tax">{{translate('messages.vat/tax No')}} </label>
                                    <input type="text" name="tax_no" class="form-control"
                                        placeholder="{{translate('vat/tax No')}}" value="{{$store->tax_no}}">
                                </div>
                            </div>
                        </div>
                        <div class="row g-3 my-0">
                            <div class="col-lg-4 col-sm-6">
                                <div class="form-group mb-0">
                                    ...
                                    <select name="module_id" required class="form-control js-select2-custom"
                                        ...
                                        <option value="{{$module->id}}" {{$store->
                                            module_id==$module->id?'selected':''}}>{{$module->module_name}}</option>
                                        @endforeach
                                    </select>
                                </div>
                            </div>
                            <div class="col-lg-8 col-sm-6">
                                ...
                                $delivery_time_start = preg_match('([0-9]+[\-][0-9]+\s[min|hours|days])',
                                $store->delivery_time??'')?explode('-',$store->delivery_time)[0]:10;
                                $delivery_time_end = preg_match('([0-9]+[\-][0-9]+\s[min|hours|days])',
                                $store->delivery_time??'')?explode(' ',explode('-',$store->delivery_time)[1])[0]:30;
                                $delivery_time_type = preg_match('([0-9]+[\-][0-9]+\s[min|hours|days])',
                                $store->delivery_time??'')?explode(' ',explode('-',$store->delivery_time)[1])[1]:'min';
                                @endphp
                                <div class="form-group mb-0">
                                ...
                                <div class="d-flex flex-column">
                                    ...
                                    <center class="py-4 my-auto">
                                        <img class="img--120" id="viewer"
                                            ...
                                            alt="{{$store->name}}" onerror='this.src="{{asset('
                                            public/assets/admin/img/400x400/img2.jpg')}}"' />
                                    </center>
                            ...
                            <div class="col-lg-4">
                                <div class="form-group">
                                    ...
                                    <select name="zone_id" id="choice_zones" onchange="get_zone_data(this.value)"
                                        ...
                                        <option value="{{$zone->id}}" {{$store->zone_id == $zone->id? 'selected':
                                            ''}}>{{$zone->name}}</option>
                                        @endif
                                        @else
                                        <option value="{{$zone->id}}" {{$store->zone_id == $zone->id? 'selected':
