                ...
                <div class="col-md-12">
                    <div class="delivery_charge_options" id="delivery_charge_options">
                        <div class="row gy-1" id="mod-label">
                            ...
                            <div class="col-sm-4">
                                <label for="">{{ translate('messages.per_km_delivery_charge') }}</label>
                            </div>
                            <div class="col-sm-4">
                                <label for="">{{ translate('messages.Minimum delivery charge') }}</label>
                            </div>
                        </div>
                        @if (count($zone->modules) > 0)
                            ...
                            <div class="row gy-1 module-row" id="module_{{ $module->id }}">
                                ...
                                <div class="col-sm-4"><input type="number" step=".01" min="0"
                                        class="form-control"
    ...
    <script>
        ...
        function add_more_delivery_charge_option(i, name) {
            ...
            $('#delivery_charge_options').append(
                ...
                '" placeholder="{{ translate('messages.choice_title') }}" readonly></div><div class="col-sm-4"><input type="number" class="form-control" name="module_data[' +
                i +
                '][per_km_shipping_charge]" step=".01" min="0" placeholder="{{ translate('messages.per_km_delivery_charge') }}" title="{{ translate('messages.per_km_delivery_charge') }}" required></div><div class="col-sm-4"><input type="number" step=".01" min="0" class="form-control" name="module_data[' +
                i +
                '][minimum_shipping_charge]" placeholder="{{ translate('messages.Minimum delivery charge') }}" title="{{ translate('messages.Minimum delivery charge') }}" required></div></div>'
            );
        }
        function add_parcel_module(i, name) {
            ...
            $('#delivery_charge_options').append(
                '<div class="row gy-1 module-row" id="module_' + i +
                '"><div class="col-sm-4"><input type="text" class="form-control" value="' + n +
                '" placeholder="{{ translate('messages.choice_title') }}" readonly></div><div class="col-sm-4"><input type="number" name="module_data[' +
                i +
                '][per_km_shipping_charge]" class="form-control" step=".01" min="0" placeholder="{{ translate('Set charge from parcel category') }}" value="" title="{{ translate('messages.per_km_delivery_charge') }}" readonly></div><div class="col-sm-4"><input type="number" name="module_data[' +
                i +
                '][minimum_shipping_charge]" step=".01" min="0" class="form-control" placeholder="{{ translate('Set charge from parcel category') }}" value="" title="{{ translate('messages.Minimum delivery charge') }}" readonly></div></div>'
            );
        }
    </script>
@endpush
