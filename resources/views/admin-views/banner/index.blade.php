                        ...
                        <form action="{{route('admin.banner.store')}}" method="post" id="banner_form">
                            ...
                            <div class="row g-3">
                                ...
                                <!--</div>-->
                                    ...
                                    <div class="col-lg-6">
                                    <div class="h-100 d-flex flex-column">
                                        <label class="mt-auto mb-0 d-block text-center">{{translate('messages.image')}} <small class="text-danger">* ( {{translate('messages.ratio')}} 3:1 )</small></label>
                                        <center class="py-3 my-auto">
                                            <img class="img--vertical" id="viewer"
                                                src="{{asset('public/assets/admin/img/900x400/img1.jpg')}}" alt="campaign image"/>
                                        </center>
                                        <div class="custom-file">
                                            <input type="file" name="image" id="customFileEg11" class="custom-file-input">
                                            <label class="custom-file-label" for="customFileEg11">{{translate('messages.choose')}} {{translate('messages.file')}}</label>
                                        </div>
                                    </div>
                                </div>
                                        ...
                                        <span class="">
                                           ...
                                           $data= strstr($banner['image'], '.');
                                            ...
                                            <video width="320" height="240" controls>
                                                  <source src="{{asset('storage/app/public/banner')}}/{{$banner['image']}}" type="video/mp4">
                                                  
                                                </video>
                                            @endif
                                            
                                            <!--<img class="img--ratio-3 w-auto h--50px rounded mr-2" src="{{asset('storage/app/public/banner')}}/{{$banner['video']}}"-->
                                            <!--     onerror="this.src='{{asset('/public/assets/admin/img/900x400/img1.jpg')}}'" alt="{{$banner->name}} image">-->
                                            ...
                                            <!--<video width="320" height="240" controls>-->
                                            <!--      <source src="{{asset('storage/app/public/banner')}}/{{$banner['video']}}" type="video/mp4">-->
