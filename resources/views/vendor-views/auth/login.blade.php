        ...
        <div class="auth-wrapper vendor-login">
            <div class="auth-wrapper-left">
                <div class="auth-left-cont">
                    ...
                    {{-- <img onerror="this.src='{{asset('/public/assets/admin/img/favicon.png')}}'"
                        src="{{ asset('storage/app/public/business/' . $store_logo) }}" alt="public/img"> --}}
                    <img src="{{asset('/public/assets/admin/css/images/4.png')}} ">
                    <h2 class="title">{{translate('Your')}} <span class="d-block">{{translate('All Service')}}</span>
                        <strong class="text--039D55">{{translate('in one field')}}....</strong></h2>
                </div>
            </div>
            <div class="auth-wrapper-right">
                ...
                <div class="auth-wrapper-form">
                    <div class="auth-header">
                        <div class="mb-5">
                            <img src="{{asset('/public/assets/admin/css/images/3.png')}} " width="300" height="100">
                    ...
                    <form class="login_form" action="{{route('vendor.auth.login')}}" method="post"
                        ...
                        <div class="row p-2">
                            <div class="col-6 pr-0">
                                <input type="text" class="form-control form-control-lg" name="custome_recaptcha"
                                    value="{{env('APP_MODE')=='dev'? session('six_captcha'):''}}" id="custome_recaptcha"
                                    required placeholder="{{\translate('Enter recaptcha value')}}" style="border: none"
                                    autocomplete="off">
                            </div>
                        ...
                        <button type="submit" class="btn btn-lg btn-block btn--primary">{{ translate('messages.sign_in')
                            }}</button>
                        <div class="toggle-login">
                            {{ translate('Login as Store Employee') }}? <span class="toggle-login-btn text-yellow"
                                data-type="emloyee" target-login="Store Employee Sign in">{{ translate('login here')
                                }}</span>
                        </div>
                    </form>
                    <!-- End Form -->
                    ...
                    <form class="login_form" action="{{route('vendor.auth.employee.login')}}" method="post"
                        ...
                        <div class="toggle-login">
                            {{ translate('Login as Store Owner') }}? <span class="toggle-login-btn text-yellow"
                                data-type="emloyee" target-login="Store Owner Sign in">{{ translate('messages.login
                                here') }}</span>
                        </div>
