                        ...
                        <div class="row row-margin-top">
                            <div class="col-md-6">
                                <div class="form-group">
                                    ...
                                    <select name="zone_id" id="choice_zones" required class="form-control __form-control js-select2-custom"
                            ...
                            <div class="col-md-6 mb-3">
                                <div class="form-group">
                                    ...
                                    <select name="module_id" required
                                            class="form-control __form-control js-select2-custom"  data-placeholder="{{translate('messages.select')}} {{translate('messages.module')}}">
