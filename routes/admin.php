...
Route::group(['namespace' => 'Admin', 'as' => 'admin.'], function () {
    ...
    Route::group(['middleware' => ['admin']], function () {
        ...
        Route::group(['prefix' => 'item', 'as' => 'item.', 'middleware' => ['module:item']], function () {
            ...
            Route::post('store/search', 'ItemController@search_store')->name('store-search');
        ...
        Route::group(['prefix' => 'pos', 'as' => 'pos.'], function () {
            ...
            Route::group(['middleware' => ['module:pos']], function () {
                ...
                Route::get('invoice/{id}', 'POSController@generate_iexportnvoice');
        ...
        Route::group(['prefix' => 'report', 'as' => 'report.', 'middleware' => ['module:report']], function () {
            ...
            // Mis Reports Route
            Route::get('order-mis', 'ReportController@order_mis_report')->name('order.mis');
            Route::get('order-mis-export', 'ReportController@order_mis_export')->name('order.mis.export');
            Route::get('export-report', 'ReportController@export_report')->name('export');
        });
